...
const projects: Project[] = [
    ...
    },
    {
        ...
        purpose: 'Digitise the entire condo management workflow — from billing to maintenance — for both managers and residents.',
        overview: 'A full-featured condominium management platform covering resident registration, facility booking, maintenance requests, billing, and announcements — all in one place.',
        challenge: 'Condo managers were juggling spreadsheets, WhatsApp groups, and manual billing. Residents had zero visibility into their accounts or pending requests.',
        solution: 'A role-based web platform where management and residents each have tailored dashboards. Billing is automated and maintenance tickets are tracked end-to-end.',
        features: [
